...
const DomainCard = (props: {
	...
	const canBePrimaryDomain =
		!isPrimaryDomain && domain.verified && !domainConfig?.data?.data?.misconfigured
		...
		<div className="px-8 pt-4 pb-6 space-y-2 w-full rounded-xl bg-slate-800/50">
			...
			{showButtons && (
				<div className="flex justify-end items-center space-x-4 mt-4">
					<Button onClick={() => domainConfigMutate()} variant="tertiary">
						{isLoading ? (
		...
		<div className="flex items-center p-4 space-x-8 w-full rounded bg-slate-950">
			...
			<div>
				...
				<div className="flex items-center space-x-1">
					<p className="w-full max-w-xl font-mono truncate">{value}</p>
