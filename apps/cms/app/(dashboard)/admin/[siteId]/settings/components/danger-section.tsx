...
const DangerSection = ({ site }: Props) => {
	...
	const [state, deleteSite] = useFormState(actions.deleteSite.bind(null, site), null)
	...
	return (
		<form className="py-8 px-8 pt-4 space-y-4 w-full rounded-xl bg-slate-900">
			...
			<p className="mb-8 max-w-xl text-red-500">
				Warning: This action cannot be undone. This will delete the site and all
				it&apos;s pages and data.
			</p>
			...
			<CustomAlertDialog
				...
				<AlertDialog.Description className="text-base text-slate-600">
					All pages and data will be deleted. This action cannot be undone.
